...
myBottomStatusBar = "conky -c /home/samir/.conkydzenbott | dzen2 -x '0' -y '1200' -h '17' -w '1920' -fg '" ++colorWhiteAlt ++ "' -bg '" ++ colorBlack ++ "' -fn '" ++ dzenFont ++ "' -ta r -e ''"
myTopStatusBar    = "conky -c /home/samir/.conkydzentop | dzen2 -x '920' -y '0' -h '17' -w '1000' -fg '" ++colorWhiteAlt ++ "' -bg '" ++ colorBlack ++ "' -fn '" ++ dzenFont ++ "' -ta r -e ''"
